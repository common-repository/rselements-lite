...
class Rsaddon_Elementor_lite_progress_Widget extends \Elementor\Widget_Base {
	...
	protected function render() {
		...
		<div class="rs-skill-bar <?php echo esc_html($settings['rs_linear_bar_style']); ?>  <?php echo esc_html($settings['rs_progress_bar_style']); ?>"> 
            <div <?php echo esc_attr( $this->get_render_attribute_string( 'progress-bar' ) ); ?>> 
                <span <?php echo esc_attr( $this->get_render_attribute_string( 'rs_progress_inner_text' ) ); ?>><?php echo esc_html($settings['rs_progress_inner_text']); ?></span>
